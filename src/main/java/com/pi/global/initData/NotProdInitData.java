...
public class NotProdInitData {
    ...
    public void work2() {
        ...
        freelancerService.create(user1, new PostWriteDto("프리랜서", "만들어드립니다.", true), new FreelancerWriteDto(100L, 12L), null, null, null, null);
        projectService.create(user1, new PostWriteDto("프로젝트", "만들어드립니다.", true), new ProjectWriteDto(LocalDateTime.now().plusDays(7), LocalDateTime.now(), LocalDateTime.now().plusMonths(1), "individual", "onsite", 100L, 10, 1), singleIdList, singleIdList, singleIdList);
    }
