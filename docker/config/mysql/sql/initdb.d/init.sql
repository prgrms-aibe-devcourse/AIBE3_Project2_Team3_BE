...
(
    ...
    endedDate      DATETIME,
    hirerType      VARCHAR(255),
    employmentType VARCHAR(255),
    salary         BIGINT,
    personnel      INT,
    skillLevel     INT,
    status         VARCHAR(50),
    CONSTRAINT fk_project_post FOREIGN KEY (id) REFERENCES post (id)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(
    ...
    CONSTRAINT fk_applications_post FOREIGN KEY (post_id) REFERENCES post (id),
...
(
    ...
    salary BIGINT,
    period BIGINT,
    CONSTRAINT fk_freelancer_post FOREIGN KEY (id) REFERENCES post (id)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(
    ...
    createdDate  DATETIME,
    modifiedDate DATETIME,
    CONSTRAINT fk_offers_post FOREIGN KEY (post_id) REFERENCES post (id),
...
(
    ...
    createdDate  DATETIME,
    modifiedDate DATETIME,
    CONSTRAINT fk_review_post FOREIGN KEY (post_id) REFERENCES post (id),
...
(
    ...
    createdDate  DATETIME,
    modifiedDate DATETIME,
    CONSTRAINT uk_post_category UNIQUE (post_id, category_id),
...
(
    ...
    createdDate  DATETIME,
    modifiedDate DATETIME,
    CONSTRAINT uk_post_region UNIQUE (post_id, region_id),
    CONSTRAINT fk_post_region_post FOREIGN KEY (post_id) REFERENCES post (id),
    CONSTRAINT fk_post_region_region FOREIGN KEY (region_id) REFERENCES region (id)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(
    ...
    createdDate  DATETIME,
    modifiedDate DATETIME,
    CONSTRAINT uk_post_skill UNIQUE (post_id, skill_id),
    CONSTRAINT fk_post_skill_post FOREIGN KEY (post_id) REFERENCES post (id),
    CONSTRAINT fk_post_skill_skill FOREIGN KEY (skill_id) REFERENCES skill (id)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- User 테이블 초기 데이터
INSERT INTO users (username, password, nickname, role, email, deleted, createdDate, modifiedDate)
VALUES ('admin', 'admin123!', '관리자', 'ROLE_ADMIN', 'admin@pi.com', FALSE, NOW(), NOW()),
       ('system', 'system123!', '시스템', 'ROLE_ADMIN', 'system@pi.com', FALSE, NOW(), NOW()),
       ('user1', 'user123!', '유저1', 'ROLE_USER', 'user1@pi.com', FALSE, NOW(), NOW()),
       ('user2', 'user123!', '유저2', 'ROLE_USER', 'user2@pi.com', FALSE, NOW(), NOW()),
       ('user3', 'user123!', '유저3', 'ROLE_USER', 'user34@pi.com', FALSE, NOW(), NOW());

-- Question 테이블 초기 데이터
INSERT INTO questions (title, content, user_id, createdDate, modifiedDate)
...
-- Answer 테이블 초기 데이터
INSERT INTO answers (content, user_id, question_id, createdDate, modifiedDate)
...
INSERT INTO applications (post_id, user_id, content, salary, period, createdDate, modifiedDate)
...
INSERT INTO offers (post_id, user_id, amount, createdDate, modifiedDate)
